...
[![Build](https://img.shields.io/github/actions/workflow/status/AtyaLibraries/Results/ci.yml?branch=development&style=for-the-badge&logo=githubactions&logoColor=white&label=Build)](https://github.com/AtyaLibraries/Results/actions/workflows/ci.yml)
...
The console sample under `samples/Results.Samples.Console` compiles this same pattern.
...
Benchmarks live in `benchmarks/Results.Benchmarks`.

```bash
dotnet run --project benchmarks/Results.Benchmarks/Results.Benchmarks.csproj -c Release -- --list flat
```
